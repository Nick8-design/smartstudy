...
private fun SessionScreen(
    ...
    LaunchedEffect(key1 = state.subjectList) {
        ...
        event(
            SessionEvent.UpdateSubjectAndRelatedSubject(
                subjectId = subjectId,
                relatedToSubject = state.subjectList.find { it.subjectId==subjectId }?.name
            )
        )
    ...
    DeleteDialog(
        ...
        onConfirmButtonClick = {
            event(SessionEvent.DeleteSession)
    ...
    SubjectListBottomSheet(
        ...
        onSubjectClicked = {it->
            ...
            event(SessionEvent.OnRelatedSubjectChange(it))
        },
        ...
        LazyColumn(
                ...
                ButtonSections(
                    ...
                    startButtonClick = {
                        ...
                        ServiceHelper.triggerForegroundService(
                            ...
                            event(SessionEvent.NotifyToUpdateSubject)
                        }
                    ...
                    finishButtonClick = {
                        ...
                        event(SessionEvent.SaveSession(duration))
                        if (duration>=36)
                        ServiceHelper.triggerForegroundService(
                            context = context,
                            action = ACTION_SERVICE_CANCEL
            ...
            studySessionsList(
                ...
                onDeleteIconClick = {it->
                    event(SessionEvent.OnDeleteSessionButtonClick(it))
